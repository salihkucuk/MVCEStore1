...
namespace MVCEStoreMigrationSqlServer.Migrations
{
    ...
    [Migration("20210523135028_Mig01")]
    partial class Mig01
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MvcEStoreData.Reyon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MvcEStoreData.Category", b =>
                {
                    b.HasOne("MvcEStoreData.Reyon", "Reyon")
                        .WithMany("Categories")
                        .HasForeignKey("ReyonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
